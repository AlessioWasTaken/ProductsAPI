...
import { completeOrderController, createOrderController, deleteOrderController, getAllActiveOrdersController, getAllOrdersController, getOrderByCurrentUser, getOrderController, updateOrderController } from '../controller/orders.controller';
...
export const ordersRoute = (router: express.Router) => {
    ...
    router.post('/v1/orders/update/:orderID', isAuthenticated, updateOrderController);
    ...
    router.get('/v1/ordersActiveUser', isAuthenticated, getOrderByCurrentUser);
}; 